...
// log(1/rate) for WHIR. Experiment: rate=2 with conjectured security (the rest of
// the finalization fix set unchanged) to see if rate=1 is essential or just faster.
